...
os.system("python3 train/train_expanded_names_cds.py \
    --num_female_names=2500 --num_male_names=1500 --dest=models_final/expanded_names_cds_unbalanced_2500_1500.kv \
    --name_matching_probabilities=data/2500_1500_names.npy")

os.system("python3 train/train_expanded_names_cds.py \
    --num_female_names=1500 --num_male_names=2500 --dest=models_final/expanded_names_cds_unbalanced_1500_2500.kv \
    --name_matching_probabilities=data/1500_2500_names.npy")
...
os.system("python3 train/train_expanded_names_cds.py \
    --num_female_names=2500 --num_male_names=1500 --dest=models_final/expanded_names_cds_unbalanced_2500_1500_less.kv \
    --name_matching_probabilities=data/2500_1500_names.npy \
    --less_target=True")
